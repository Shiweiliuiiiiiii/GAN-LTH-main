...
#SBATCH -J CGAN_fre_Ggradient_Drandom           # 所运行的任务名称 (自己取)
...
#SBATCH -o CGAN_fre_Ggradient_Drandom      # 打印输出的文件
...
#for seed in 0
#do
#  python train_dst.py --dataset horse2zebra --exp-name dense_cyclegan --seed $seed --rand initial_weights --exp-name dense_training_seed$seed
#done
...
#    --sparse --sparse_init ERK --density $density --update_frequency 10 --rand initial_weights --seed $s --exp-name sparse_training_balanced_density$density_seed$seed
#  done
#done
#
#
