...
#SBATCH -J CGAN_PF_uniform_G          # 所运行的任务名称 (自己取)
...
#SBATCH -o CGAN_PF_uniform_G.out    # 打印输出的文件
...
do
  ...
  do
    ...
    --sparse --sparse_init pruning --density 0.5 --pruning_mode uniform_G --pruning_rate $pr --update_frequency 10 \
