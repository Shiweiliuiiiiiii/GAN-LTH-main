...
#SBATCH -J Test_SEMA.out          # 所运行的任务名称 (自己取)
...
#SBATCH -o Test_SEMA.out     # 打印输出的文件
...
python train.py --model sngan_cifar10 --exp-name sngan_cifar10_test_SEMA --init-path initial_weights \
